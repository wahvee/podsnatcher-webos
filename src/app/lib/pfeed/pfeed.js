...
var PFeed = Class.create({
	 ...
	 * @param elementIterator {Element} Element iterator from XPath result.
	 */
	 ...
	 * causing the Mojo framework to hang.
	 */
	mediaRssNode: function(elementIterator) {
		// Get the node to be processed
		var thisNode = elementIterator.iterateNext();
		// Check that a node was received
		if (thisNode) {
	 ...
	 * causing the Mojo framework to hang.
	 */
	atomNode: function() { throw {name : "NotImplementedError", message : "too lazy to implement"}; },
	/**
